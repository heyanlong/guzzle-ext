...
static zend_function_entry guzzle_psr_http_message_message_interface_method[] = {
...
void guzzle_init_psr_http_message_message_interface() {
    ...
    INIT_NS_CLASS_ENTRY(ce, PSR_HTTP_MESSAGE_NS, "MessageInterface", guzzle_psr_http_message_message_interface_method);
